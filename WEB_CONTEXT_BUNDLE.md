...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-743-random-stable-roommates-bba42a6c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-743"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-743-random-stable-roommates-bba42a6c-v1",
      "problem_contract_sha256": "f428d764d3f5e57120883ff75343f1be1b25ec0659d627b4a4739feab3c2190d",
      "problem_id": "problem:um-opg-743-random-stable-roommates-bba42a6c",
      "route_id": "route:um-opg-743-random-stable-roommates-bba42a6c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-743-random-stable-roommates-bba42a6c-source-fidelity-01",
      "graph_id": "graph:um-opg-743-random-stable-roommates-bba42a6c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-743-random-stable-roommates-bba42a6c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-743-random-stable-roommates-bba42a6c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture The probability that a random instance of the stable roommates problem on $n \\in 2{\\mathbb N}$ people admits a solution is $\\Theta( n ^{-1/4} )$."
          },
          "statement_sha256": "251ff21e7ecafc97f4d773d1c9ba058630552d17b7671bf0f23b47a9b5505bd5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-743-random-stable-roommates-bba42a6c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-743-random-stable-roommates-bba42a6c-root",
      "route_id": "route:um-opg-743-random-stable-roommates-bba42a6c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-743-1039064264c3",
        "url": "https://www.unsolvedmath.com/problems/OPG-743"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
